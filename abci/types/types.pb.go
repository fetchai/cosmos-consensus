...
type ResponseEndBlock struct {
	...
	DkgValidatorUpdates   []ValidatorUpdate `protobuf:"bytes,4,rep,name=dkg_validator_updates,json=dkgValidatorUpdates,proto3" json:"dkg_validator_updates"`
	XXX_NoUnkeyedLiteral  struct{}          `json:"-"`
	XXX_unrecognized      []byte            `json:"-"`
	XXX_sizecache         int32             `json:"-"`
}
...
func (m *ResponseEndBlock) GetDkgValidatorUpdates() []ValidatorUpdate {
	if m != nil {
		return m.DkgValidatorUpdates
	}
	return nil
}
...
type ConsensusParams struct {
	...
	Entropy              *EntropyParams   `protobuf:"bytes,4,opt,name=entropy,proto3" json:"entropy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *ConsensusParams) GetEntropy() *EntropyParams {
	if m != nil {
		return m.Entropy
	}
	return nil
...
// EntropyParams contains config for DKG and entropy generation
type EntropyParams struct {
	// Note: must be greater than 0
	AeonLength                  int64    `protobuf:"varint,1,opt,name=aeon_length,json=aeonLength,proto3" json:"aeon_length,omitempty"`
	InactivityWindowSize        int64    `protobuf:"varint,2,opt,name=inactivity_window_size,json=inactivityWindowSize,proto3" json:"inactivity_window_size,omitempty"`
	RequiredActivityPercentage  int64    `protobuf:"varint,3,opt,name=required_activity_percentage,json=requiredActivityPercentage,proto3" json:"required_activity_percentage,omitempty"`
	SlashingThresholdPercentage int64    `protobuf:"varint,4,opt,name=slashing_threshold_percentage,json=slashingThresholdPercentage,proto3" json:"slashing_threshold_percentage,omitempty"`
	XXX_NoUnkeyedLiteral        struct{} `json:"-"`
	XXX_unrecognized            []byte   `json:"-"`
	XXX_sizecache               int32    `json:"-"`
}

func (m *EntropyParams) Reset()         { *m = EntropyParams{} }
func (m *EntropyParams) String() string { return proto.CompactTextString(m) }
func (*EntropyParams) ProtoMessage()    {}
func (*EntropyParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_9f1eaa49c51fa1ac, []int{29}
}
func (m *EntropyParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EntropyParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EntropyParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EntropyParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EntropyParams.Merge(m, src)
}
func (m *EntropyParams) XXX_Size() int {
	return m.Size()
}
func (m *EntropyParams) XXX_DiscardUnknown() {
	xxx_messageInfo_EntropyParams.DiscardUnknown(m)
}

var xxx_messageInfo_EntropyParams proto.InternalMessageInfo

func (m *EntropyParams) GetAeonLength() int64 {
	if m != nil {
		return m.AeonLength
	}
	return 0
...
func (m *EntropyParams) GetInactivityWindowSize() int64 {
	if m != nil {
		return m.InactivityWindowSize
	}
	return 0
}

func (m *EntropyParams) GetRequiredActivityPercentage() int64 {
	if m != nil {
		return m.RequiredActivityPercentage
	}
	return 0
}

func (m *EntropyParams) GetSlashingThresholdPercentage() int64 {
	if m != nil {
		return m.SlashingThresholdPercentage
	}
	return 0
}
...
type Header struct {
	...
	Entropy              BlockEntropy `protobuf:"bytes,15,opt,name=entropy,proto3" json:"entropy"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *Header) GetEntropy() BlockEntropy {
	if m != nil {
		return m.Entropy
	}
	return BlockEntropy{}
...
type BlockEntropy struct {
	GroupSignature       []byte   `protobuf:"bytes,1,opt,name=group_signature,json=groupSignature,proto3" json:"group_signature,omitempty"`
	Round                int64    `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	AeonLength           int64    `protobuf:"varint,3,opt,name=aeon_length,json=aeonLength,proto3" json:"aeon_length,omitempty"`
	DkgId                int64    `protobuf:"varint,4,opt,name=dkg_id,json=dkgId,proto3" json:"dkg_id,omitempty"`
	NextAeonStart        int64    `protobuf:"varint,5,opt,name=next_aeon_start,json=nextAeonStart,proto3" json:"next_aeon_start,omitempty"`
	SuccessfulVals       []int64  `protobuf:"varint,6,rep,packed,name=successful_vals,json=successfulVals,proto3" json:"successful_vals,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *BlockEntropy) Reset()         { *m = BlockEntropy{} }
func (m *BlockEntropy) String() string { return proto.CompactTextString(m) }
func (*BlockEntropy) ProtoMessage()    {}
func (*BlockEntropy) Descriptor() ([]byte, []int) {
	return fileDescriptor_9f1eaa49c51fa1ac, []int{35}
}
func (m *BlockEntropy) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BlockEntropy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BlockEntropy.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BlockEntropy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlockEntropy.Merge(m, src)
}
func (m *BlockEntropy) XXX_Size() int {
	return m.Size()
}
func (m *BlockEntropy) XXX_DiscardUnknown() {
	xxx_messageInfo_BlockEntropy.DiscardUnknown(m)
}

var xxx_messageInfo_BlockEntropy proto.InternalMessageInfo

func (m *BlockEntropy) GetGroupSignature() []byte {
	if m != nil {
...
func (m *BlockEntropy) GetRound() int64 {
	if m != nil {
		return m.Round
	}
	return 0
...
func (m *BlockEntropy) GetAeonLength() int64 {
	if m != nil {
		return m.AeonLength
	}
	return 0
...
func (m *BlockEntropy) GetDkgId() int64 {
	if m != nil {
		return m.DkgId
	}
	return 0
...
func (m *BlockEntropy) GetNextAeonStart() int64 {
	if m != nil {
		return m.NextAeonStart
	}
	return 0
}

func (m *BlockEntropy) GetSuccessfulVals() []int64 {
	if m != nil {
		return m.SuccessfulVals
	}
	return nil
}
...
func (m *Evidence) GetThreshold() int64 {
	if m != nil {
		return m.Threshold
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*EntropyParams)(nil), "tendermint.abci.types.EntropyParams")
	golang_proto.RegisterType((*EntropyParams)(nil), "tendermint.abci.types.EntropyParams")
	...
	proto.RegisterType((*BlockEntropy)(nil), "tendermint.abci.types.BlockEntropy")
	golang_proto.RegisterType((*BlockEntropy)(nil), "tendermint.abci.types.BlockEntropy")
...
var fileDescriptor_9f1eaa49c51fa1ac = []byte{
	...
	,
}
...
func (this *ResponseEndBlock) Equal(that interface{}) bool {
	...
	if len(this.DkgValidatorUpdates) != len(that1.DkgValidatorUpdates) {
		return false
	}
	for i := range this.DkgValidatorUpdates {
		if !this.DkgValidatorUpdates[i].Equal(&that1.DkgValidatorUpdates[i]) {
			return false
		}
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
...
func (this *EntropyParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*EntropyParams)
	if !ok {
		that2, ok := that.(EntropyParams)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.AeonLength != that1.AeonLength {
		return false
	}
	if this.InactivityWindowSize != that1.InactivityWindowSize {
		return false
	}
	if this.RequiredActivityPercentage != that1.RequiredActivityPercentage {
		return false
	}
	if this.SlashingThresholdPercentage != that1.SlashingThresholdPercentage {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false
...
func (this *BlockEntropy) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*BlockEntropy)
	if !ok {
		that2, ok := that.(BlockEntropy)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !bytes.Equal(this.GroupSignature, that1.GroupSignature) {
		return false
	}
	if this.Round != that1.Round {
		return false
	...
	if this.DkgId != that1.DkgId {
		return false
	}
	if this.NextAeonStart != that1.NextAeonStart {
		return false
	}
	if len(this.SuccessfulVals) != len(that1.SuccessfulVals) {
		return false
	}
	for i := range this.SuccessfulVals {
		if this.SuccessfulVals[i] != that1.SuccessfulVals[i] {
			return false
		}
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
...
func (m *ResponseEndBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DkgValidatorUpdates) > 0 {
		for iNdEx := len(m.DkgValidatorUpdates) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DkgValidatorUpdates[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *EntropyParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EntropyParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EntropyParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.SlashingThresholdPercentage != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.SlashingThresholdPercentage))
		i--
		dAtA[i] = 0x20
	}
	if m.RequiredActivityPercentage != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.RequiredActivityPercentage))
		i--
		dAtA[i] = 0x18
	}
	if m.InactivityWindowSize != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.InactivityWindowSize))
		i--
		dAtA[i] = 0x10
	}
	if m.AeonLength != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.AeonLength))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *BlockEntropy) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BlockEntropy) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlockEntropy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.SuccessfulVals) > 0 {
		dAtA42 := make([]byte, len(m.SuccessfulVals)*10)
		var j41 int
		for _, num1 := range m.SuccessfulVals {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if m.NextAeonStart != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.NextAeonStart))
		i--
		dAtA[i] = 0x28
	}
	if m.DkgId != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.DkgId))
		i--
		dAtA[i] = 0x20
	}
	if m.AeonLength != 0 {
	...
	if len(m.GroupSignature) > 0 {
		i -= len(m.GroupSignature)
		copy(dAtA[i:], m.GroupSignature)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.GroupSignature)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func NewPopulatedResponseEndBlock(r randyTypes, easy bool) *ResponseEndBlock {
	...
	if r.Intn(5) != 0 {
		v30 := r.Intn(5)
		this.DkgValidatorUpdates = make([]ValidatorUpdate, v30)
		for i := 0; i < v30; i++ {
			v31 := NewPopulatedValidatorUpdate(r, easy)
			this.DkgValidatorUpdates[i] = *v31
		}
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypes(r, 5)
...
func NewPopulatedConsensusParams(r randyTypes, easy bool) *ConsensusParams {
	...
	if r.Intn(5) != 0 {
		this.Entropy = NewPopulatedEntropyParams(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypes(r, 5)
	}
...
func NewPopulatedEntropyParams(r randyTypes, easy bool) *EntropyParams {
	this := &EntropyParams{}
	this.AeonLength = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.AeonLength *= -1
	}
	this.InactivityWindowSize = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.InactivityWindowSize *= -1
	}
	this.RequiredActivityPercentage = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.RequiredActivityPercentage *= -1
	}
	this.SlashingThresholdPercentage = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.SlashingThresholdPercentage *= -1
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypes(r, 5)
	}
...
func NewPopulatedHeader(r randyTypes, easy bool) *Header {
	...
	v51 := NewPopulatedBlockEntropy(r, easy)
	this.Entropy = *v51
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedBlockID(r randyTypes, easy bool) *BlockID {
	...
	v53 := NewPopulatedPartSetHeader(r, easy)
	this.PartsHeader = *v53
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTypes(r, 3)
	}
	return this
...
func NewPopulatedBlockEntropy(r randyTypes, easy bool) *BlockEntropy {
	this := &BlockEntropy{}
	v54 := r.Intn(100)
	this.GroupSignature = make([]byte, v54)
	for i := 0; i < v54; i++ {
		this.GroupSignature[i] = byte(r.Intn(256))
	}
	...
	this.DkgId = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.DkgId *= -1
	}
	this.NextAeonStart = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.NextAeonStart *= -1
	}
	v55 := r.Intn(10)
	this.SuccessfulVals = make([]int64, v55)
	for i := 0; i < v55; i++ {
		this.SuccessfulVals[i] = int64(r.Int63())
		if r.Intn(2) == 0 {
			this.SuccessfulVals[i] *= -1
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func (m *ResponseEndBlock) Size() (n int) {
	...
	if len(m.DkgValidatorUpdates) > 0 {
		for _, e := range m.DkgValidatorUpdates {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *EntropyParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.AeonLength != 0 {
		n += 1 + sovTypes(uint64(m.AeonLength))
	}
	if m.InactivityWindowSize != 0 {
		n += 1 + sovTypes(uint64(m.InactivityWindowSize))
	}
	if m.RequiredActivityPercentage != 0 {
		n += 1 + sovTypes(uint64(m.RequiredActivityPercentage))
	}
	if m.SlashingThresholdPercentage != 0 {
		n += 1 + sovTypes(uint64(m.SlashingThresholdPercentage))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *BlockEntropy) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.GroupSignature)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	if m.Round != 0 {
	...
	if m.DkgId != 0 {
		n += 1 + sovTypes(uint64(m.DkgId))
	}
	if m.NextAeonStart != 0 {
		n += 1 + sovTypes(uint64(m.NextAeonStart))
	}
	if len(m.SuccessfulVals) > 0 {
		l = 0
		for _, e := range m.SuccessfulVals {
			l += sovTypes(uint64(e))
		}
...
func (m *ResponseEndBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DkgValidatorUpdates", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DkgValidatorUpdates = append(m.DkgValidatorUpdates, ValidatorUpdate{})
			if err := m.DkgValidatorUpdates[len(m.DkgValidatorUpdates)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *EntropyParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EntropyParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EntropyParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AeonLength", wireType)
			}
			m.AeonLength = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AeonLength |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InactivityWindowSize", wireType)
			}
			m.InactivityWindowSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InactivityWindowSize |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequiredActivityPercentage", wireType)
			}
			m.RequiredActivityPercentage = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RequiredActivityPercentage |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlashingThresholdPercentage", wireType)
			}
			m.SlashingThresholdPercentage = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SlashingThresholdPercentage |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *BlockEntropy) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlockEntropy: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlockEntropy: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GroupSignature", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.GroupSignature = append(m.GroupSignature[:0], dAtA[iNdEx:postIndex]...)
			if m.GroupSignature == nil {
				m.GroupSignature = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextAeonStart", wireType)
			}
			m.NextAeonStart = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NextAeonStart |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType == 0 {
				...
				m.SuccessfulVals = append(m.SuccessfulVals, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.SuccessfulVals) == 0 {
					m.SuccessfulVals = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SuccessfulVals", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
