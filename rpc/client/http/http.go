...
func (c *baseRPCClient) BroadcastTxAsyncBulk(txs []types.Tx) (*ctypes.ResultBroadcastTx, error) {
...
func (c *baseRPCClient) broadcastTXs(route string, txs []types.Tx) (*ctypes.ResultBroadcastTx, error) {
	result := new(ctypes.ResultBroadcastTx)
