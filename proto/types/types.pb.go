...
type Vote struct {
	...
	TimestampSignature   []byte        `protobuf:"bytes,9,opt,name=timestamp_signature,json=timestampSignature,proto3" json:"timestamp_signature,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *Vote) GetTimestampSignature() []byte {
	if m != nil {
...
type Commit struct {
	...
	CombinedSignature    string         `protobuf:"bytes,7,opt,name=combined_signature,json=combinedSignature,proto3" json:"combined_signature,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *Commit) GetCombinedSignature() string {
	if m != nil {
...
type CommitSig struct {
	...
	TimestampSignature   []byte      `protobuf:"bytes,5,opt,name=timestamp_signature,json=timestampSignature,proto3" json:"timestamp_signature,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *CommitSig) GetTimestampSignature() []byte {
	if m != nil {
		return m.TimestampSignature
	}
	return nil
...
var fileDescriptor_ff06f8095857fb18 = []byte{
	...
	,
}
