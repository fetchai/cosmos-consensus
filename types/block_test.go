...
func TestBlockValidateBasic(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Entropy too large", func(blk *Block) {
			...
			blk.Entropy = *NewBlockEntropy(zeros[0:len(zeros)], 0, 1, 0, -1)
		}, true},
	}
...
func TestHeaderHash(t *testing.T) {
	testCases := []struct {
		...
		{"Generates expected hash", &Header{
			...
			Entropy:            *NewBlockEntropy(tmhash.Sum([]byte("group_signature")), 0, 1, 0, -1),
		}, hexBytesFromString("4CF204EB9162B5EA396C168CE771B2645F3AB381AEE6D035AF0F00DA1C2A20D0")},
