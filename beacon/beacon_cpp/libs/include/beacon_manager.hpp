...
private:
  ...
  std::vector<std::unique_ptr<PublicKey>>
                         public_key_shares_;  ///< Public keys of cabinet generated by DKG (v_i)
  ...
  std::vector<std::vector<std::unique_ptr<PublicKey>>>
                                                       C_ik;  ///< Verification vectors from cabinet members
  ...
  std::unordered_map<CabinetIndex,
                     std::pair<std::set<CabinetIndex>, std::vector<std::unique_ptr<PrivateKey>>>>
